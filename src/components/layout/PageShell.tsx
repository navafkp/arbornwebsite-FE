...
export default function PageShell({ children }: { children: React.ReactNode }) {
  ...
  const NO_SHELL_HEADER = ["/", "/select-size", "/orders/detail", "/about", "/about/founder", "/about/journey"];
...
export function PageHeader({
  ...
  if (searchOpen) {
    return (
      <header className="fixed top-0 right-0 left-0 z-50 flex h-[67px] items-center border-b border-black/5 bg-[#fcf0ef] px-4">
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 flex h-[67px] items-center justify-between bg-[#fcf0ef] px-4">
