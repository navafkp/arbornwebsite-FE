...
export default function Hero() {
  return (
    <>
      <PageHeader showBackButton={false} showSearch={false} />
      ...
      <div className="mx-auto max-w-7xl px-4 pt-3 pb-4 sm:px-6 md:px-8 md:py-16 md:pb-8 lg:px-12">
        ...
        <div className="relative md:hidden">
          ...
          <h1 className="relative mt-1.5 font-serif text-3xl leading-[1.05] font-bold text-foreground">
            Hello,
            <br />
            <span className="text-accent">Beautiful!</span>{" "}
            <HeartIcon filled className="inline h-6 w-6 text-accent align-middle" />
          </h1>
        ...
        <div className="md:grid md:grid-cols-2 md:items-center md:gap-16 lg:gap-24">
          ...
          <div className="hidden md:block">
            ...
            <ContinueShoppingButton className="mt-9 inline-flex items-center gap-2 rounded-full bg-accent px-8 py-4 text-xs font-medium tracking-widest text-white uppercase transition hover:bg-accent-dark" />
          ...
          <div className="relative mt-3 h-[36vh] w-full overflow-hidden rounded-3xl md:mt-0 md:h-auto md:aspect-[3/4]">
            <Image
              src={HERO_IMAGE}
        ...
        <div className="md:hidden">
          <ContinueShoppingButton className="mt-3 flex w-full items-center justify-center gap-2 rounded-full bg-accent px-7 py-4 text-xs font-medium tracking-widest text-white uppercase transition hover:bg-accent-dark" />

          <SecureLine className="mt-1.5 flex items-center justify-center gap-1.5 text-xs text-[var(--muted)]" />
        </div>
      </div>
