...
export default function HomeHeader() {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 flex h-24 items-center justify-between border-b border-black/5 bg-background px-4">
      {searchOpen ? (
        <>
          <SearchBar
            autoFocus
          ...
          <button
            ...
            className="ml-3 flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-black/60"
          >
        ...
        <>
          <button
            ...
            aria-label="Search"
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-black/70"
          >
